...
export const LeftSideDog = ({ notas, content, data, cambios, setParrafoACambiar, setParrafoCambiado, setAnchorPoint, show, setShow, claseLeftSide, setPosicionParrafo }) => {
    ...
    return <section className={claseLeftSide}>
        ...
        <div className="text-justify p-4 w-full resize-none border-2 border-black min-h-texto-principal max-h-texto-principal overflow-y-scroll">
            <DogContent notas={notas} content={content} data={data} cambios={cambios} handleContextMenu={handleContextMenu} />
        </div>
    </section >
}
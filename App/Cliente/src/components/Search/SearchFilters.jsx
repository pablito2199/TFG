                ...
                !mostrar
                    ...
                    <div className='flex text-white text-center mt-4'>
                        <button onClick={() => setMostrar(!mostrar)} className="bg-black focus:outline-none relative inline-flex items-center font-medium cursor-pointer">
                            <span className='font-serif p-2'>Amosar filtros avanzados</span>
                    ...
                    <div>
                        <div className='flex text-white text-center mt-4'>
                            <button onClick={() => setMostrar(!mostrar)} className="bg-black focus:outline-none relative inline-flex items-center font-medium cursor-pointer">
                                <span className='font-serif p-2'>Agochar filtros avanzados</span>
                        ...
                        <div className='flex flex-col bg-white-lex-gal p-2 font-semibold'>
                            <div className='flex justify-center gap-24 border-b border-blue-400'>
                                <div className='p-2 flex items-center justify-center gap-1'>
                                    <span className='font-serif ml-1 text-lg italic mr-1'>Buscar só no título</span>
                                ...
                                <div className='p-2 flex items-center justify-center gap-1'>
                                    <span className='font-serif ml-1 text-lg italic mr-1'>Buscar por frase exacta</span>
                            ...
                            <div className='flex w-full'>
                                <div className='w-1/3 flex flex-col text-left align-top m-2 px-3'>
                                    <span className='font-serif ml-1 text-lg italic mb-1'>Número DOG dende</span>
                                ...
                                <div className='w-1/3 flex flex-col text-left align-top m-2 px-3'>
                                    <span className='font-serif ml-1 text-lg italic mb-1'>Número DOG ata</span>
                                ...
                                <div className='w-1/3 flex flex-col text-left align-top m-2 px-3'>
                                    <span className='font-serif ml-1 text-lg italic mb-1'>Criterio de ordenación</span>

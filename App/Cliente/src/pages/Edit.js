...
export default function Edit() {
    ...
    return <div className='flex flex-col items-center w-full screen-min3:ml-20 z-0'>
        <ParagraphEditor
                    ...
                    <>
                        {
                            !modal
                                ...
                                :
                                <main className='z-0 w-full flex'>
                                    <div className='flex flex-col bg-white border-4 fixed left-16 h-full'>
                                        <XIcon className='fixed self-end h-5 cursor-pointer border border-black top-4 right-5' onClick={() => { setModal(false) }} />
                                        <div className='mt-3'>
                                            <span className='font-semibold ml-10 italic bg-blue-lex-gal text-white px-4 py-2'>Editando lei vinculada...</span>
                                        </div>

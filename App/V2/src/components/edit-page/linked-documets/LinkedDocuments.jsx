...
export const LinkedDocuments = ({ parrafosAModificar, leiPrincipal, leiSeleccionada, setLeiSeleccionada, cambiosVinculadas, setCambiosVinculadas, cambiosLocales, setCambiosLocales }) => {
    let documentos = []
